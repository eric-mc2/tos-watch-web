...
export const siteName = 'ToS Watch';
export const siteDescription = 'Watching and rating changes to consumer terms of service agreements.';
export const siteType = 'Person'; // schema.org (Person indicates the formal authority for the site is not a company.)
...
export const opengraph_default_alt =
  "Visible content: history and interpretation of changes to consumer terms of service."; // alt text for default meta image"
export const blog = {
  // RSS feed
